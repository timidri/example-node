...
aws elb configure-health-check --load-balancer-name {{ELBNAME}} --health-check Target=HTTP:8080/,Interval=5,UnhealthyThreshold=2,HealthyThreshold=2,Timeout=3  --region {{REGION}}
...
aws elb configure-health-check --load-balancer-name {{ELBNAME}} --health-check Target=HTTP:8080/,Interval=30,UnhealthyThreshold=2,HealthyThreshold=2,Timeout=5 --region {{REGION}}
